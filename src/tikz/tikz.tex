...
\forestset{
  ...
  node/.style={draw, circle, minimum size=0.7cm, inner sep=1pt},
}
...
\begin{center}
  \begin{forest}
    ...
    [50, node % nó raiz
      [30, node % filho esquerdo
        [20, node % filho esquerdo de 30
          [10, node % filho esquerdo de 20
            [⊥, null]      % filho esquerdo de 10 (nó nulo, desenhado em cinza)
            [15, node]     % filho direito de 10 (nó normal)
          ]
        ]
        [40, node % filho direito de 30
          [⊥, null]        % filho esquerdo de 40 (nó nulo)
          [45, node              % filho direito de 40
            [⊥, null]      % filho esquerdo de 45 (nó nulo)
            [48, node]     % filho direito de 45 (nó normal)
          ]
        ]
      ]
      [70, node % filho direito de 50
        [60, node % filho esquerdo de 70
          [55, node
            [48, node]     % filho esquerdo de 55
            [⊥, null]      % filho direito de 55
          ]
        ]
        [80, node % filho direito de 70
          [⊥, null]        % filho esquerdo de 80
          [90, node]       % filho direito de 80
        ]
      ]
    ]
  \end{forest}
